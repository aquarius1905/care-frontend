      ...
      <div class="form__info box-shadow">
          ...
          <div class="form__item-wrap">
            <div class="form__item-name-wrap">
              <validation-provider v-slot="{ errors }" rules="required|max:127">
                ...
                <input type="text" id="last_name" class="name-input" v-model="care_receiver.last_name" name="姓" placeholder="山田">
            ...
            <div class="form__item-name-wrap">
              <validation-provider v-slot="{ errors }" rules="required|max:127">
                ...
                <input type="text" id="first_name" class="name-input" v-model="care_receiver.first_name" name="名" placeholder="太郎">
                <div class="error">{{ errors[0] }}</div>
              </validation-provider>
            </div>
          </div>
        ...
        <div class="form__item">
          <validation-provider v-slot="{ errors }" rules="required|numeric|length:7">
            ...
            <div class="flex">
              <input type="text" id="post_code" class="input" v-model="care_receiver.post_code" placeholder="1050004" required>
        ...
        <div class="form__item">
          <validation-provider v-slot="{ errors }" rules="required|numeric|length:10">
            ...
            <input type="text" id="insured_number" class="input" v-model="care_receiver.insured_number" placeholder="1234567890"
              required>
            <div class="error">{{ errors[0] }}</div>
          </validation-provider>
        </div>
          ...
          <div class="form__item-wrap">
            <div class="form__item-name-wrap">
              <validation-provider v-slot="{ errors }" rules="required|max:127">
                ...
                <input type="text" id="last_name" class="name-input" v-model="care_receiver.keyperson_lastname" name="姓"
                  placeholder="山田">
                <div class="error">{{ errors[0] }}</div>
              </validation-provider>
            </div>
            <div class="form__item-name-wrap">
              <validation-provider v-slot="{ errors }" rules="required|max:127">
                ...
                <input type="text" id="first_name" class="name-input" v-model="care_receiver.keyperson_firstname" name="名"
                  placeholder="花子">
                <div class="error">{{ errors[0] }}</div>
              </validation-provider>
            </div>
            ...
            <div class="form__item-name-wrap">
              <validation-provider v-slot="{ errors }" rules="required|max:127|full_sized_katakana">
                ...
                <input type="text" id="last_name_furigana" class="name-input"
                  v-model="care_receiver.keyperson_lastname_furigana" placeholder="ヤマダ" required>
                <div class="error">{{ errors[0] }}</div>
              </validation-provider>
            </div>
            <div class="form__item-name-wrap">
              <validation-provider v-slot="{ errors }" rules="required|max:127|full_sized_katakana">
                ...
                <input type="text" id="first_name_furigana" class="name-input"
                  v-model="care_receiver.keyperson_firstname_furigana" placeholder="ハナコ" required>
                <div class="error">{{ errors[0] }}</div>
              </validation-provider>
            </div>
          </div>
